  ...
  static std::map<std::string, std::vector<WebUISimpleItem> >
                                                           localized_strings = {
    {
      ...
      std::string("checkout"), {
        ...
        { "unverifiedWalletMessage", IDS_BRAVE_REWARDS_CHECKOUT_UNVERIFIED_WALLET_MESSAGE },
        { "unverifiedWalletTitle", IDS_BRAVE_REWARDS_CHECKOUT_UNVERIFIED_WALLET_TITLE },
        { "connectWalletPrefix", IDS_BRAVE_REWARDS_CHECKOUT_CONNECT_WALLET_PREFIX },
        { "connectWalletSuffix", IDS_BRAVE_REWARDS_CHECKOUT_CONNECT_WALLET_SUFFIX },
