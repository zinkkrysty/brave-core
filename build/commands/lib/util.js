...
const util = {
  ...
  updateBranding: () => {
    ...
    // Clean untracked files at chrome/android/java/res to avoid
    // "Found files not listed in the sources list of the BUILD.gn" error
    util.runGit(config.srcDir, ['clean', '-f', 'chrome/android/java/res'], true)
