...
export function UnverifiedWalletPanel () {
  ...
  return (
    <>
      ...
      <LineSeparator /> 
      <ConnectWallet>{locale.get('connectWalletPrefix')}<StyledNoticeLink href={'chrome://rewards'} target={'_blank'}>{locale.get('connectWalletSuffix')}</StyledNoticeLink></ConnectWallet>
