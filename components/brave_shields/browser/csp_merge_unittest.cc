...
class CspMergeTest : public testing::Test {
 public:
  CspMergeTest() {}
  ~CspMergeTest() override {}
...
TEST_F(CspMergeTest, MergeTwoEmptyPolicies) {
...
TEST_F(CspMergeTest, MergeEmptyIntoNonEmpty) {
...
TEST_F(CspMergeTest, MergeNonEmptyIntoEmpty) {
  const auto a = NO_POLICY;
  auto b = POLICY1;
...
TEST_F(CspMergeTest, MergeNonEmptyIntoNonEmpty) {
  const auto a = POLICY1;
  auto b = POLICY2;
